 ...
 * Explanation: There is only 1 extra candy, therefore only kid 1
 * will have the greatest number of candies among the kids regardless of who takes the extra candy.
 * Example 3:
 * <p>
 ...
 * 1 <= extraCandies <= 50
 */
public class $1431KidsWithTheGreatestNumberOfCandies {

    public static void main(String[] args) {
        PrintUtil.printList4(kidsWithCandies(new int[]{2, 3, 5, 1, 3}, 3));
    }
